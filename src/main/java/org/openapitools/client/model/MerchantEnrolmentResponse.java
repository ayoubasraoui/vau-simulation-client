...
import org.openapitools.client.model.MerchantResponse;
 ...
 */
@JsonPropertyOrder({
  MerchantEnrolmentResponse.JSON_PROPERTY_MERCHANTS,
  MerchantEnrolmentResponse.JSON_PROPERTY_ACQUIRER_SEGMENT_ID
})
...
public class MerchantEnrolmentResponse {
  ...
  public MerchantEnrolmentResponse merchants(@jakarta.annotation.Nonnull List<MerchantResponse> merchants) {
  ...
  @JsonProperty(JSON_PROPERTY_MERCHANTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMerchants(@jakarta.annotation.Nonnull List<MerchantResponse> merchants) {
    this.merchants = merchants;
  }

  public MerchantEnrolmentResponse acquirerSegmentId(@jakarta.annotation.Nonnull Integer acquirerSegmentId) {
