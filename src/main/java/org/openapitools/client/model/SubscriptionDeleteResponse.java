...
import org.openapitools.client.model.DeleteSubscription;
 ...
 */
@JsonPropertyOrder({
  SubscriptionDeleteResponse.JSON_PROPERTY_MERCHANT_ID,
  SubscriptionDeleteResponse.JSON_PROPERTY_SUBSCRIPTIONS,
  SubscriptionDeleteResponse.JSON_PROPERTY_SUB_MERCHANT_NAME,
  SubscriptionDeleteResponse.JSON_PROPERTY_ACQUIRER_SEGMENT_ID
})
...
public class SubscriptionDeleteResponse {
  ...
  @jakarta.annotation.Nonnull
  private List<DeleteSubscription> subscriptions = new ArrayList<>();
  ...
  public SubscriptionDeleteResponse merchantId(@jakarta.annotation.Nonnull String merchantId) {
  ...
  public SubscriptionDeleteResponse subscriptions(@jakarta.annotation.Nonnull List<DeleteSubscription> subscriptions) {
  ...
  public List<DeleteSubscription> getSubscriptions() {
    return subscriptions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUBSCRIPTIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSubscriptions(@jakarta.annotation.Nonnull List<DeleteSubscription> subscriptions) {
    this.subscriptions = subscriptions;
  }

  public SubscriptionDeleteResponse subMerchantName(@jakarta.annotation.Nullable String subMerchantName) {
  ...
  public SubscriptionDeleteResponse acquirerSegmentId(@jakarta.annotation.Nonnull Integer acquirerSegmentId) {
