 ...
 */
@JsonPropertyOrder({
  DeleteSubscriptionAttributes.JSON_PROPERTY_CARDHOLDER_ACCOUNT_NUMBER,
  DeleteSubscriptionAttributes.JSON_PROPERTY_ACQUIRER_OR_MERCHANT_PROPRIETARY_INFO
})
...
public class DeleteSubscriptionAttributes {
  ...
  public DeleteSubscriptionAttributes cardholderAccountNumber(@jakarta.annotation.Nonnull String cardholderAccountNumber) {
  ...
  public DeleteSubscriptionAttributes acquirerOrMerchantProprietaryInfo(@jakarta.annotation.Nullable String acquirerOrMerchantProprietaryInfo) {
