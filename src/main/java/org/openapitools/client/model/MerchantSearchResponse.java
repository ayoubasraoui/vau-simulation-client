 ...
 */
@JsonPropertyOrder({
  MerchantSearchResponse.JSON_PROPERTY_MERCHANTS,
  MerchantSearchResponse.JSON_PROPERTY_ACQUIRER_SEGMENT_ID
})
...
public class MerchantSearchResponse {
  ...
  public MerchantSearchResponse merchants(@jakarta.annotation.Nonnull List<Merchant> merchants) {
  ...
  @JsonProperty(JSON_PROPERTY_MERCHANTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMerchants(@jakarta.annotation.Nonnull List<Merchant> merchants) {
    this.merchants = merchants;
  }

  public MerchantSearchResponse acquirerSegmentId(@jakarta.annotation.Nonnull Integer acquirerSegmentId) {
