 ...
 */
@JsonPropertyOrder({
  RejectedSubscriptionResponse.JSON_PROPERTY_REJECT_REASON,
  RejectedSubscriptionResponse.JSON_PROPERTY_REJECT_REASON_CODE
})
...
public class RejectedSubscriptionResponse {
  ...
  public RejectedSubscriptionResponse rejectReason(@jakarta.annotation.Nonnull String rejectReason) {
  ...
  public RejectedSubscriptionResponse rejectReasonCode(@jakarta.annotation.Nonnull String rejectReasonCode) {
