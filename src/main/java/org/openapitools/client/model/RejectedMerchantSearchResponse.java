 ...
 */
@JsonPropertyOrder({
  RejectedMerchantSearchResponse.JSON_PROPERTY_REJECT_REASON,
  RejectedMerchantSearchResponse.JSON_PROPERTY_REJECT_REASON_CODE,
  RejectedMerchantSearchResponse.JSON_PROPERTY_ACQUIRER_SEGMENT_ID
})
...
public class RejectedMerchantSearchResponse {
  ...
  public RejectedMerchantSearchResponse rejectReason(@jakarta.annotation.Nonnull String rejectReason) {
  ...
  public RejectedMerchantSearchResponse rejectReasonCode(@jakarta.annotation.Nonnull String rejectReasonCode) {
  ...
  public RejectedMerchantSearchResponse acquirerSegmentId(@jakarta.annotation.Nonnull Integer acquirerSegmentId) {
