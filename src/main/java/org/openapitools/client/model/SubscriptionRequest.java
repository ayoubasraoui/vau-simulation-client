...
import org.openapitools.client.model.SubscriptionRequestAttributes;
 ...
 */
@JsonPropertyOrder({
  SubscriptionRequest.JSON_PROPERTY_MERCHANT_ID,
  SubscriptionRequest.JSON_PROPERTY_SUBSCRIPTIONS,
  SubscriptionRequest.JSON_PROPERTY_SUB_MERCHANT_NAME,
  SubscriptionRequest.JSON_PROPERTY_ACQUIRER_SEGMENT_ID
})
...
public class SubscriptionRequest {
  ...
  @jakarta.annotation.Nonnull
  private List<SubscriptionRequestAttributes> subscriptions = new ArrayList<>();
  ...
  public SubscriptionRequest merchantId(@jakarta.annotation.Nonnull String merchantId) {
  ...
  public SubscriptionRequest subscriptions(@jakarta.annotation.Nonnull List<SubscriptionRequestAttributes> subscriptions) {
  ...
  public List<SubscriptionRequestAttributes> getSubscriptions() {
    return subscriptions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUBSCRIPTIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSubscriptions(@jakarta.annotation.Nonnull List<SubscriptionRequestAttributes> subscriptions) {
    this.subscriptions = subscriptions;
  }

  public SubscriptionRequest subMerchantName(@jakarta.annotation.Nullable String subMerchantName) {
  ...
  public SubscriptionRequest acquirerSegmentId(@jakarta.annotation.Nonnull Integer acquirerSegmentId) {
